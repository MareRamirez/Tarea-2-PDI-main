...
# Mostrar la imagen con el efecto de espejo en una sola figura
plt.figure() 
plt.subplot(1, 2, 1) 
...
plt.subplot(1, 2, 2) 
plt.title('img numeros original y espejo') 
...
window_size = (7, 7)  # Ajusta del tamaño 
...
umbral = sob.max() * 0.5 # Umbral para binarizar la imagen
